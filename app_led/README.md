...
- **LED module type**: `CONFIG_APP_LED_TYPE`
    - LEDC: `CONFIG_APP_LED_TYPE_LEDC=y` (default)
    - WS2812: `CONFIG_APP_LED_TYPE_WS2812=y`
- **GPIO pins**:
    - LEDC: `APP_LED_LEDC_GPIO_NUM_[R/G/B]` (default: R=0, G=1, B=8)
    - WS2812: `APP_LED_WS2812_GPIO_NUM=?` (default: 8)

Or if using `idf.py menuconfig`, then head to `Component config > ESP RainMaker App LED Control`.